                ...
                {CryptoStore.loaded.cryptoNames &&
                    !CryptoStore.loaded.cryptoPrices && (
                        <motion.div
                            ...
                            key={'getCryptoPrices'}
                            initial={
                                !CryptoStore.loaded.cryptoPrices && { x: -1000 }
                            }
                            animate={
                                !CryptoStore.loaded.cryptoPrices
                                    ? { x: 0, opacity: [0, 0.5, 1] }
                    ...
                    !CryptoStore.loaded.annualPriceVariances && (
                        ...
                        >
                            <LoadingButton
                                ...
                                size="large"
                            >
                                Calculate annual price variances for all crypto
                                prices
                            </LoadingButton>
                            <Typography
                                variant="subtitle2"
                            ...
                            >
                                Calculate the average annual price variances for
                ...
                {CryptoStore.loaded.cryptoNames &&
                    ...
                    !CryptoStore.loaded.kMeansData && (
                        ...
                        >
                            ...
                            >
                                Formats the data into a usable structure for use
